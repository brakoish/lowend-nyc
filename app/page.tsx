    ...
    <main>
      ...
      <section className="max-w-[1440px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
          ...
          <a href="https://breakawaymusic.com/newyork/" target="_blank" rel="noopener noreferrer" className="bg-[#FF2B2B] p-4 flex flex-col justify-between min-h-[280px] group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2 focus-visible:ring-offset-page-bg">
            <div>
